...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form method="POST" action="{{ route('admin.pembimbing-lapang.go.update') }}" class="kt-form">
                @csrf
                    ...
                    <div class="kt-section kt-section--first">
                        ...
                        <div class="kt-section__body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input name="nama" type="text" class="form-control" placeholder="Tuliskan nama siswa disini" value="{{ $data['pembimbing_lapang']->nama }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input name="email" type="text" class="form-control" placeholder="Tuliskan email siswa disini" value="{{ $data['pembimbing_lapang']->email }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input name="no_telpon" type="tel" class="form-control" placeholder="Tuliskan nomor telepon siswa disini" value="{{ $data['pembimbing_lapang']->no_telpon }}">
