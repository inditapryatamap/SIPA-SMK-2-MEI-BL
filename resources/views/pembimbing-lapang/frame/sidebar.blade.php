      ...
      <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
         ...
         <ul class="kt-menu__nav ">
            ...
            <a href="javascript:;"
               ...
               <span class="kt-menu__link-text">Validasi Kegiatan</span><i
            ...
            <div class="kt-menu__submenu ">
               ...
               <ul class="kt-menu__subnav">
                  <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
                     ...
                     class="kt-menu__link-text">Validasi Kegiatan</span></span></li>
                  <li class="kt-menu__item " aria-haspopup="true"><a
                     href="{{ route('pembimbing-lapang.validasi.jurnal-harian.list') }}" class="kt-menu__link "><i
                     class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                     class="kt-menu__link-text">Jurnal Harian</span></a>
            </li>
                 <li class="kt-menu__item " aria-haspopup="true"><a
                     href="{{ route('admin.penilaian.kepribadian.list') }}"
                     class="kt-menu__link "><i
                     class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                     class="kt-menu__link-text">Kehadiran</span></a>
            </li>
            <li class="kt-menu__item " aria-haspopup="true"><a
                     href="{{ route('pembimbing-lapang.validasi.penilaian.list') }}"
                     class="kt-menu__link "><i
                     class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                     class="kt-menu__link-text">Penilaian PKL</span></a>
            </li>
               </ul>
            </div>
         </li>
