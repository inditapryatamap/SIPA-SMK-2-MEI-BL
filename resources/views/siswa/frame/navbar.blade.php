                   ...
                   <div class="kt-mycart__body kt-scroll" data-scroll="true" data-height="245"
                      ...
                      <div class="kt-mycart__item">
                         <div class="kt-mycart__container">
                            ...
                            <a href="#" class="kt-mycart__pic">
                            <img src="{{ url('assets') }}/media/products/product15.jpg" title=""
                               alt="">
                            </a>
                         </div>
                      </div>
             ...
             <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                <li class="kt-nav__item kt-nav__item--active">
                   ...
                   <span class="kt-nav__link-icon"><img
                      src="{{ url('assets') }}/media/flags/020-flag.svg" alt="" /></span>
                ...
                <li class="kt-nav__item">
                   <a href="#" class="kt-nav__link">
                   <span class="kt-nav__link-icon"><img
                      src="{{ url('assets') }}/media/flags/016-spain.svg" alt="" /></span>
                ...
                <li class="kt-nav__item">
                   <a href="#" class="kt-nav__link">
                   <span class="kt-nav__link-icon"><img
                      src="{{ url('assets') }}/media/flags/017-germany.svg" alt="" /></span>
