                                    ...
                                    <div class="row border-bottom mb-2">
                                        ...
                                        <div class="col-md-8">
                                            <div class="kt-timeline-v3__item kt-timeline-v3__item--success ">
                                                ...
                                                <div class="kt-timeline-v3__item-desc" style="padding-left: 14rem">
                                                    <span class="kt-timeline-v3__item-text text-right">
                                                    ...
                                                    <span class="kt-timeline-v3__item-user-name mr-3">
                                                        @if ($data['kehadiran'][$i]->status_guru_pembimbing == 1)
                                                            <span class="kt-link kt-link--dark kt-timeline-v3__itek-link text-success font-bold">
                                                                Divalidasi
                                                            </span>
                                                        @elseif ($data['kehadiran'][$i]->status_guru_pembimbing == 2)
                                                    ...
                                                    <span class="kt-timeline-v3__item-user-name">
                                                        @if ($data['kehadiran'][$i]->status_pembimbing_lapang == 1)
                                                            <span class="kt-link kt-link--dark kt-timeline-v3__itek-link text-success font-bold">
                                                                Divalidasi
                                                            </span>
                                                        @elseif ($data['kehadiran'][$i]->status_pembimbing_lapang == 2)
                                                            <span class="kt-link kt-link--dark kt-timeline-v3__itek-link text-danger font-bold">
                                                                Tidak Divalidasi
                                                            </span>
                                                        @else
                                        ...
                                        <div class="col-md-4">
                                            <div class="centered-action-jurnal">
                                                <a href="{{ route('pembimbing-lapang.validasi.kehadiran.go_validasi', ['id_jurnal_harian' => $data['kehadiran'][$i]->id, 'tipe' => 1]) }}" class="btn btn-success btn-icon mr-2"><i class="fa fa-check"></i></a>
                                                <a href="{{ route('pembimbing-lapang.validasi.kehadiran.go_validasi', ['id_jurnal_harian' => $data['kehadiran'][$i]->id, 'tipe' => 2]) }}" class="btn btn-danger btn-icon"><i class="fa fa-times"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                @endfor
