...
class JurnalHarianController extends Controller
{
    public function index()
    {
        ...
        ->paginate(10);
        return view('guru-pembimbing.pages.validasi.jurnal-harian.list', compact('data'));
    }
    ...
    public function detail($id_pengajuan)
    {
        ...
        ->get();
        return view('guru-pembimbing.pages.validasi.jurnal-harian.detail', compact('data'));
    }
